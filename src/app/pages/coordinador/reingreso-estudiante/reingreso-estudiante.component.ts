...
export class ReingresoEstudianteComponent implements OnInit {
  ...
  cargarSolicitudes(): void {
    this.reingresoService.getCoordinadorRequests().subscribe({
      next: (sols) => {
  ...
  aprobarSolicitudSeleccionada(): void {
    ...
    this.reingresoService.approveAsCoordinador(this.selectedSolicitud.id_solicitud).subscribe({
      next: () => {
  ...
  rechazarSolicitudSeleccionada(): void {
    ...
    dialogRef.afterClosed().subscribe((motivo: string) => {
      if (motivo) {
        this.reingresoService.rejectAsCoordinador(this.selectedSolicitud!.id_solicitud, motivo).subscribe({
          next: () => {
